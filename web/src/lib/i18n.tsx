...
const en: Dict = {
  ...
  gridHover: 'Tap or hover a square to read its exact scoreline and result. Scorelines capped at 4 goals per side.',
  gridDistCaption: "{team}'s finish across all {n} possible final-day scorelines",
  oddsCol: 'Q%',
  oddsColTitle: 'Chance to reach the Round of 32',
  oddsTitle: 'Qualification odds',
  oddsSubtitle: 'chance to reach the Round of 32',
  oddsModelNote:
...
const fa: Dict = {
  ...
  gridHover: 'برای دیدن نتیجهٔ دقیق هر خانه روی آن بزنید یا نشانگر را روی آن ببرید. نتایج تا ۴ گل برای هر تیم در نظر گرفته شده‌اند.',
  gridDistCaption: 'رده پایانی {team} در همهٔ {n} نتیجهٔ ممکن روز پایانی',
  oddsCol: 'صعود٪',
  oddsColTitle: 'شانس رسیدن به مرحلهٔ یک‌شانزدهم نهایی',
  oddsTitle: 'شانس صعود',
  oddsSubtitle: 'احتمال رسیدن به مرحلهٔ یک‌شانزدهم نهایی',
  oddsModelNote:
  ...
  oddsLoading: 'در حال برآورد…',
  oddsUnavailable: 'شانس صعود در دسترس نیست.',
  colTeam: 'تیم',
  colGrp: 'گروه',
  colGF: 'گل زده',
  colForm: 'روند',
