...
const en: Dict = {
  ...
  gridHover: 'Hover a square to read its exact scoreline and result. Scorelines capped at 4 goals per side.',
...
const fa: Dict = {
  ...
  gridHover: 'برای دیدن نتیجهٔ دقیق هر خانه، نشانگر را روی آن ببرید. نتایج تا ۴ گل برای هر تیم در نظر گرفته شده‌اند.',
