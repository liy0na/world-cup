...
// Source: FIFA World Cup 2026 Regulations, Annex C (the 495 round-of-32
// third-placed-team combinations), via Wikipedia template
// "2026 FIFA World Cup third-place table". Parsed + validated 2026-06-20:
// all 495 combinations present, every assignment distinct and within the
// allowed-group constraints of its winner slot.
//
// Key   = the eight qualifying third-placed groups, letters sorted A..L.
// Value = { <winnerGroup>: <thirdPlaceGroup> } for the eight winner slots
//         that face a third-placed team: A, B, D, E, G, I, K, L.
import type { GroupLetter } from '../types';

export type ThirdSlotAssignment = Partial<Record<GroupLetter, GroupLetter>>;
